...
mutationFn: (orderData: any) => printReceipt(orderData),
onError: (error) => {
...
// Auto-print after order is created
if (response.data) {
await printMutation.mutateAsync(response.data);
}
...
const isProcessing = createOrderMutation.isPending || printMutation.isPending;
